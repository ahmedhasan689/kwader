<?php $__env->startSection('page_title', 'كوادر'); ?>
    ...
    <section class="search-job">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <img src="<?php echo e(asset('Front_Assets/img/Group 253.png')); ?>" alt="">
                        <h6>كتابة و ترجمة</h6>
                    </div>
                </div>
                <div class="col-lg-3">
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-lg-4 card">
                    <img src="<?php echo e(asset('Front_Assets/img/Group 383.png')); ?>" alt="">
    ...
    <section class="search-job search-job-bb ">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="image">
                        <img src="<?php echo e(asset('Front_Assets/img/Group 832.png')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.front_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\kwader\resources\views/Home/index.blade.php ENDPATH**/ ?>