            ...
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <div class="col-sm-6 col-md-3 mg-t-10" style="margin-right: -12px">
                        <form action="<?php echo e(route('admin.employer.restore')); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <button href="<?php echo e(route('admin.employer.trash')); ?>" class="btn btn-info">
                                إستعادة الكل
                            </button>
                        </form>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\kwader\resources\views/Dashboard/employer/trash.blade.php ENDPATH**/ ?>