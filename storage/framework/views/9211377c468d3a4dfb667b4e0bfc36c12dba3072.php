            ...
            <div class="tab-content pt-5" style="width:80%;" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="v-pills-information" role="tabpanel"
                    ...
                    <div class="row info-page">
                        <div class="col-lg-6">
                            <form action="<?php echo e(route('employee.settings.setNames')); ?>" method="POST" style="height:300px ;">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo e($employee->user->first_name); ?>">
...
unset($__errorArgs, $__bag); ?>" id="exampleInputPassword1" value="<?php echo e($employee->user->last_name); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-6">
                            <form action="<?php echo e(route('employee.settings.setAvatar')); ?>" method="POST" style="height:300px ;" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                ...
                                <a href="#" style="display: flex; align-items:center; margin-top: 50px;">
                                    <div class="image mb-5">
                                        <img src="<?php echo e($employee->image); ?>" alt="" id="output">
                    ...
                    <div class="row info-page mt-3">
                        ...
                        <form action="<?php echo e(route('employee.settings.setInfo')); ?>" method="POST" class="info-page2">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            ...
                            <div class="d-flex">
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="date_of_birth" class="form-control" value="<?php echo e($employee->date_of_birth); ?>" id="date" aria-describedby="emailHelp">
                                    </div>
                                    <div class="mb-3">
                                        <label for="country" class="form-label">الدولة</label>
                                        <select class="form-select" aria-label="Default select" name="country_id">
                                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if($country->id == $employee->country->id): ?> selected <?php endif; ?> value="<?php echo e($country->id); ?>">
                                ...
                                <div>
                                    <div class="mb-3 ">
                                        ...
                                        <select class="form-select" aria-label="Default select" name="gender">
                                            <option <?php if($employee->gender == 'Male'): ?> selected <?php endif; ?> value="Male">ذكر</option>
                                            <option <?php if($employee->gender == 'Female'): ?> selected <?php endif; ?> value="Female">أنثى</option>
                                        </select>
                                    </div>
                                    <div class="mb-3 ">
                                        ...
                                        <select class="form-select" aria-label="Default select language" name="language_id">
                                            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if($language->id == $employee->language->id): ?> selected <?php endif; ?> value="<?php echo e($language->id); ?>">
                ...
                <div class="tab-pane fade" id="v-pills-gmail" role="tabpanel" aria-labelledby="v-pills-gmail-tab"
                     tabindex="0">
                    <div class="row info-page ">
                        <form action="<?php echo e(route('employee.settings.setEmail')); ?>" method="POST" class="info-page2">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e($employee->user->email); ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="tab-pane fade" id="v-pills-password" role="tabpanel" aria-labelledby="v-pills-password-tab" tabindex="0">
                    <div class="row info-page">
                        <form action="<?php echo e(route('employee.settings.resetPassword')); ?>" method="POST" class="mb-2">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                ...
                <div class="tab-pane fade " id="v-pills-phone" role="tabpanel" aria-labelledby="v-pills-phone-tab"
                     tabindex="0">
                    <div class="row info-page">
                        <form action="<?php echo e(route('employee.settings.setPhoneNumber')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <h4>
                                رقم الجوال
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($employee->user->phone_number); ?>" id="phone-number">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="tab-pane fade mb-2" id="v-pills-delete" role="tabpanel" aria-labelledby="v-pills-delete-tab"
                     tabindex="0">
                    <div class="row info-page">
                        <form action="<?php echo e(route('employee.settings.deleteAccount')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.front_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\kwader\resources\views/employee/settings/index.blade.php ENDPATH**/ ?>