                        ...
                        <div class="row">
                            <?php $__currentLoopData = $existings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $existing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($existing->type == 'kawader'): ?>
                                    <div class="col-md-4">
                                        <a href="<?php echo e(route('employer.existing.show', ['id' => $existing->id])); ?>" class="kwader-link">
                                            <div class="kwader-card">
                                                ...
                                                <br>
                                                <img src="<?php echo e(asset('Front_Assets/img/ss.png')); ?>" class="mb-4 kwader-img" width="50" height="50">
                                                <br>

                                                <button class="btn btn-success kwader-count" disabled>
                                                    <?php echo e($favorites); ?> كوادر
                                                </button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content" style="height: 200px;">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo e(route('employer.existing.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.front_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\kwader\resources\views/employer/favorite/index.blade.php ENDPATH**/ ?>