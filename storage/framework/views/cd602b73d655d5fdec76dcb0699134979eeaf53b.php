    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('admin.employer.store')); ?>" data-parsley-validate="" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="first_name" placeholder="أدخل الأسم الأول" type="text">
...
unset($__errorArgs, $__bag); ?>" name="last_name" placeholder="أدخل الأسم الأخير" type="text">
...
unset($__errorArgs, $__bag); ?>" name="email" placeholder="أدخل البريد الإلكتروني" type="email">
...
unset($__errorArgs, $__bag); ?>" name="phone_number" placeholder="أدخل رقم الجوال" type="text">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input class="form-control fc-datepicker" name="date_of_birth" placeholder="MM/DD/YYYY" type="text">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\kwader\resources\views/Dashboard/employer/create.blade.php ENDPATH**/ ?>