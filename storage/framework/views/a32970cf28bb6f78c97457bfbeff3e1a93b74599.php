<?php $__env->startSection('page_title', 'البحث عن كوادر'); ?>
                    ...
                    <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card" style="height: 360px">
                            ...
                            <div class="title">
                                ...
                                <i data-bs-toggle="modal" data-bs-target="#favModal-<?php echo e($employee->id); ?>"
                                   class="fa-regular fa-heart"></i>

                                <!-- Modal -->
                                <div class="modal fade" id="favModal-<?php echo e($employee->id); ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="<?php echo e(route('employer.existing.favoriteStore')); ?>"
                                                      method="POST">
                                                    <?php echo csrf_field(); ?>
                            ...
                            <div class="name" style="width: 180px; top: 130px; left: 124px;">
                                <a href="<?php echo e(route('employee.dashboard.show', ['id' => $employee->id])); ?>"
                                   style="cursor: pointer; text-decoration: none">
                                    <h4 style="font-size: 20px"><?php echo e($employee->user->first_name . ' ' . $employee->user->last_name); ?></h4>
                                </a>
                                <img src="<?php echo e(asset('flags') . '/' . $employee->country->code . '.png'); ?>" width="25"
                                     height="15">
                            ...
                            <div class="group mt-2">
                                <?php if($employee->skills): ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <span
                                        title="<?php echo e(implode(', ',  $remaining_array)); ?>">+ <?php echo e(count($remaining_array)); ?></span>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.front_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\kwader\resources\views/employer/find_employer/index.blade.php ENDPATH**/ ?>