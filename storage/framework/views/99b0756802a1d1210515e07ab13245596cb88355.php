    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('admin.employer.update', ['id' => $user->id])); ?>" data-parsley-validate="" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="country_id">
                                    ...
                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($country->id); ?>" <?php if( $country->id == $user->employer->country_id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>" name="language_id">
                                    ...
                                    <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($language->id); ?>" <?php if( $language->id == $user->employer->language_id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>" name="gender">
                                    ...
                                    <option value="Male" <?php if( $user->employer->gender == 'Male'): ?> selected <?php endif; ?>>
                                        ذكر
                                    </option>
                                    <option value="Female" <?php if( $user->employer->gender == 'Female'): ?> selected <?php endif; ?>>
                                        أنثى
                                    </option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input class="form-control fc-datepicker" name="date_of_birth" placeholder="MM/DD/YYYY" type="text" value="<?php echo e($user->employer->date_of_birth); ?>">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\kwader\resources\views/Dashboard/employer/edit.blade.php ENDPATH**/ ?>