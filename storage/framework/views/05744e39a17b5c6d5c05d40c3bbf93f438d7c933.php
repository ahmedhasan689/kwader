            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">قائمة أصحاب العمل</h4>
                        <i class="mdi mdi-dots-horizontal text-gray"></i>
                    </div>
                    <p class="tx-12 tx-gray-500 mb-2">
                        هنا تجد كافة أصحاب العمل في الموقع، يمكنك التعديل والحذف من هنا
                    </p>
                    ...
                    <div class="table-responsive border-top userlist-table">
                        <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <img alt="avatar" class="rounded-circle avatar-md mr-2" src="<?php echo e($user->employer->image); ?>">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.employer.edit', ['id' => $user->id])); ?>" class="btn btn-sm btn-info">
                                        ...
                                        <div class="modal-content tx-size-sm">
                                            <div class="modal-body tx-center pd-y-20 pd-x-20">
                                                ...
                                                <h4 class="tx-danger mg-b-20">
                                                    إنتباه : أنت تقوم بحذف صاحب عمل
                                                </h4>
                                                <p class="mg-b-20 mg-x-20">
                                                    سيتم جدولة الحذف لصاحب العمل خلال 30 يوماً ، ثم يتم الحذف التلقائي ، يمكنك أن تجد صاحب العمل من خلال قائمة المحذوفات
                                                </p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\kwader\resources\views/Dashboard/employer/index.blade.php ENDPATH**/ ?>