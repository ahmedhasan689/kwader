            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card1 d-flex">
                        ...
                        <div>
                            <img src="<?php echo e(asset('Front_Assets/img/Group 1613.png')); ?>" alt="">
                        </div>
                    </div>
                    <div class="card2">
                        <div class="title">
                        ...
                        <div class="d-flex cont">
                            <nav class="nav flex-column">
                                <a class="nav-link active" aria-current="page" href="#">
                                    <img src="<?php echo e(asset('Front_Assets/img/Ellipse 306.png')); ?>" alt="">
                                    المفتوحة
                                </a>
                                <a class="nav-link" href="#">
                                    <img src="<?php echo e(asset('Front_Assets/img/Group 1507.png')); ?>" alt="">
                                    قيد المراجعة
                                </a>
                                <a class="nav-link" href="#">
                    ...
                    <div class="card3">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-3  text-center">
                                <img src="<?php echo e(asset('Front_Assets/img/Group 381.png')); ?>" alt="">
                                <p>اختر الكادر المناسب</p>
                            </div>
                            <div class="col-3  text-center">
                                <img src="<?php echo e(asset('Front_Assets/img/Group 426.png')); ?>" alt="">
...
<?php echo $__env->make('layouts.front_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\kwader\resources\views/employer/index.blade.php ENDPATH**/ ?>