...
@section('content')
    <form action="{{ route('job.store', ['step' => 2]) }}" method="POST">
        @csrf
        <div class="addJob">
                        ...
                        <div class="row d-flex gap-2">
                            <div class="col-lg-4" style="border: 1px solid #898EA3; border-radius:5px; padding-bottom: 30px;">
                                <div class="mb-3 px-4 mt-4">
                                    ...
                                    <input type="text" name="job_title" placeholder="مثال: مبرمج،مصمم جرافيك، مدير تسويقي" class="form-control" id="jobName" aria-describedby="company">
                                </div>
                                <div class="mb-3 px-4 mt-4">
                                    ...
                                    <div class="over">
                                        @foreach( $fields as $field )
                                            <div class="form-check" style="margin-right: 4px">
                                                <input class="form-check-input job_field" type="radio" name="job_field" value="{{ $field->field_name }}" id="{{ $field->id }}">
                                ...
                                <div class="years px-4 mt-4">
                                    <h5>سنوات الخبرة</h5>
                                    <div class="form-check" style="margin-right: 4px">
                                        <input class="form-check-input job_field" type="radio" name="years_of_experience" value="0-2 سنوات" id="exper1">
                                        <label class="form-check-label" for="exper1">
                                            0-2 سنوات
                                        </label>
                                    </div>
                                    <div class="form-check" style="margin-right: 4px">
                                        <input class="form-check-input job_field" type="radio" name="years_of_experience" value="5-2 سنوات" id="exper2">
                                        <label class="form-check-label" for="exper2">
                                            5-2 سنوات
                                        </label>
                                    </div>
                                    <div class="form-check" style="margin-right: 4px">
                                        <input class="form-check-input job_field" type="radio" name="years_of_experience" value="10-5 سنوات" id="exper3">
                                        <label class="form-check-label" for="exper3">
                                            10-5 سنوات
                                        </label>
                                    </div>
                                    <div class="form-check" style="margin-right: 4px">
                                        <input class="form-check-input job_field" type="radio" name="years_of_experience" value="+10 سنوات" id="exper4">
                            ...
                            <div class="col-lg-8" style="border: 1px solid #898EA3; border-radius:5px;">
                                    ...
                                    <div class="d-flex gap-2  px-4 mt-4">
                                        <div class="mb-3" style="width:50% ;">
                                            ...
                                            <input style="width:100% ;" type="number" class="form-control" name="salary" id="sallary">
                                        </div>
                                        <div class="mb-3">
                                            <label for="location" class="form-label" style="display: block">نظام العمل</label>

                                            <div style="display:inline; margin-left: 25px;">
                                                <input type="radio" id="system5" name="job-system" value="دوام كامل">
                                                <label for="system5" style="">
                                                    دوام كامل
                                                </label>
                                            </div>
                                            <div style="display:inline;">
                                                <input type="radio" id="system6" name="job-system" value="دوام جزئي">
                                                <label for="system6">
                                                    دوام جزئي
                                                </label>
                                            </div>
                                    ...
                                    <div class="d-flex gap-2  px-4">
                                        <div class="mb-3" style="width:50% ;">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="country_id">
                                                <option selected>الرجاء إختيار الدولة من هنا</option>
                                        ...
                                        <div class="mb-3" style="width:50% ;">
                                            ...
                                            <select id="languages" class="form-select" aria-label="Default select example" multiple name="languages[]" style="height: 20px">
                                    ...
                                    <div class="d-flex gap-2  px-4 mt-4">
                                        <div class="mb-3" style="width:100% ;">
                                            <label for="sallary" class="form-label">
                                                وصف الوظيفة
                                            </label>
                                            <br>
                                            <textarea style="width:100% ;" name="job_description" cols="30" rows="10"></textarea>
                                        </div>
                                    </div>
