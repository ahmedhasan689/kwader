                        ...
                        @else
                            <div class="first-step" style="display:none;">
                                ...
                                <div class="row d-flex gap-2">
                                    <div class="col-lg-4"
                                         style="border: 1px solid #898EA3; border-radius:5px; padding-bottom: 30px;">
                                        <div class="mb-3 px-4 mt-4">
                                            <label for="jobName" class="form-label">
                                                المسمى الوظيفي
                                            </label>
                                            <input type="text" name="job_title"
                                                   placeholder="مثال: مبرمج،مصمم جرافيك، مدير تسويقي"
                                                   class="form-control @error('job_title') is-invalid @enderror"
                                                   id="jobName" aria-describedby="company">
                                            @error('job_title')
                                        ...
                                        <div class="mb-3 px-4 mt-4">
                                            ...
                                            <input type="text" placeholder="ابحث عن المجال" class="form-control"
                                                   id="field" aria-describedby="company">
                                            <div class="over">
                                                @foreach( $fields as $field )
                                                    <div class="form-check" style="margin-right: 4px">
                                                        <input
                                                            class="form-check-input @error('job_field') is-invalid @enderror"
                                                            type="radio" name="job_field" value="{{ $field->id }}"
                                                            id="{{ $field->id }}">
                                        ...
                                        <div class="specialize px-4 mt-4">
                                            ...
                                            <input type="text" placeholder="ابحث عن الاختصاص" class="form-control"
                                                   id="specialized" aria-describedby="company">
                                        ...
                                        <div class="mb-3 px-4 mt-4">
                                            ...
                                            <select class="form-select" id="job_skills" multiple
                                                    aria-label="Default select example" name="skills[]">
                                        ...
                                        <div class="years px-4 mt-4">
                                            ...
                                            <div class="form-check" style="margin-right: 4px">
                                                <input
                                                    class="form-check-input job_field @error('years_of_experience') is-invalid @enderror"
                                                    type="radio" name="years_of_experience" value="0-2 سنوات"
                                                    id="exper1">
                                            ...
                                            <div class="form-check" style="margin-right: 4px">
                                                <input
                                                    class="form-check-input job_field @error('years_of_experience') is-invalid @enderror"
                                                    type="radio" name="years_of_experience" value="5-2 سنوات"
                                                    id="exper2">
                                            ...
                                            <div class="form-check" style="margin-right: 4px">
                                                <input
                                                    class="form-check-input job_field @error('years_of_experience') is-invalid @enderror"
                                                    type="radio" name="years_of_experience" value="10-5 سنوات"
                                                    id="exper3">
                                            ...
                                            <div class="form-check" style="margin-right: 4px">
                                                <input
                                                    class="form-check-input job_field @error('years_of_experience') is-invalid @enderror"
                                                    type="radio" name="years_of_experience" value="+10 سنوات"
                                                    id="exper4">
                                    ...
                                    <div class="col-lg-8" style="border: 1px solid #898EA3; border-radius:5px;">
                                        ...
                                        <div class="d-flex gap-2  px-4 mt-4">
                                            ...
                                            <div class="mb-3">
                                                <label for="location" class="form-label" style="display: block">نظام
                                                    العمل</label>

                                                <div style="display:inline; margin-left: 25px;">
                                                    <input type="radio" id="system5"
                                                           class="form-check-input @error('job_system') is-invalid @enderror"
                                                           name="job_system" value="دوام كامل">
                                                    <label class="form-check-label" for="system5" style="">
                                                        دوام كامل
                                                    </label>
                                                </div>
                                                <div style="display:inline;">
                                                    <input type="radio" id="system6"
                                                           class="form-check-input @error('job_system') is-invalid @enderror"
                                                           name="job_system" value="دوام جزئي">
                                        ...
                                        <div class="d-flex gap-2  px-4">
                                            ...
                                            <div class="mb-3" style="width:50% ;">
                                                ...
                                                <select id="languages"
                                                        ...
                                                        aria-label="Default select example" multiple name="languages[]"
                                                        style="height: 20px">
                                            ...
                                            <div class="mb-3" style="width:100% ;">
                                                ...
                                                <div class="form-outline">
                                                    ...
                                                    <textarea
                                                        ...
                                                        name="job_description" id="textAreaExample2"
                                                        rows="12"></textarea>
                                ...
                                <p id="threeStep">
                                    جاري معالجة طلبكم, ترقب ردَّنا قريبا
                                        ...
                                        @endif
                                            <div class="row">
                                                    ...
                                                    <div class="right">
                                                        ...
                                                        <div class="d-flex ss">
                                                            <div><input type="checkbox" name="" id="">
                                                                <span>بطاقة الائتمانية</span></div>
                                                            <div class="image d-flex">
                                                                <img
                                                                    src="{{ asset('Front_Assets/img/mastercard.png') }}"
                                                                    alt="">
                                                                <img
                                                                    src="{{ asset('Front_Assets/img/visa.png') }}'"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex ss">
                                                            ...
                                                            <div class="image d-flex ">
                                                                <img
                                                                    src="{{ asset('Front_Assets/img/paypal.png') }}"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex ss">
                                                            ...
                                                            <div class="image d-flex">
                                                                <img
                                                                    src="{{ asset('Front_Assets/img/Group 620.png') }}"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-4 center mt-4">
                                                    <form action="{{ route('financial.StoreStripe') }}"
                                                          data-stripe-publishable-key="{{ env('STRIPE_KEY') }}">
                                                        <h5>تفاصيل الدفع الخاصة بك</h5>
                                                        <div class="mb-3 d-flex gap-2"
                                                             style="flex-direction:column ;">
                                                            <label for="#name">اسمك كما في البطاقة
                                                                الائتمانية</label>
                                                        ...
                                                        <div class="mb-3 d-flex gap-2">
                                                            <div><label for="#date">تاريخ انتهاء
                                                                    الصلاحية </label>
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="number" placeholder="522"
                                                        ...
                                                        <div class="mb-3 form-check ">
                                                            ...
                                                            <label class="form-check-label"
                                                                   for="exampleCheck1">احفظ البطاقة لتسهيل
                                                                الدفع في المستقبل</label>
                                                        </div>

                                                        <button type="submit" class="btn click"
                                                                style="background-color: #00B398; color: white; padding: 10px 60px;">
                                                            ادفع الان
                                                        </button>
                                                    </form>
                                                ...
                                                <div class="col-lg-4 mt-5">
                                                    <img src="{{ asset('Front_Assets/img/Group 734.png') }}"
                                                         alt="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="final" style="display:none;">
                                            <div>
                                                <img src="{{ asset('Front_Assets/img/Group 613.png') }}"
                                                     alt="">
                                                <p id="threeStep">
                                        ...
                                        <div class="px-4 mt-4" style="float:left ; ">
                                            <button type="submit"
                                                    style="background-color: #00B398; border: none; padding: 10px 20px; font-size: large;"
