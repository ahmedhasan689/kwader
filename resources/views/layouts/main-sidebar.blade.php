<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{ asset('Front_Assets/img/Group 404.png')}}" class="main-logo" alt="logo">
                </a>
...
{{--                            <i class="fa-solid fa-user-doctor mx-2"></i>--}}
{{--                            <span class="side-menu__label">قائمة الكوادر</span>--}}
{{--                        </a>--}}
{{--					</li>--}}
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li>
                                <a class="slide-item" href="{{ route('admin.employee.index') }}">
                                    قائمة الكوادر
                                </a>
                            </li>
							<li>
                                <a class="slide-item" href="{{ route('admin.employee.create') }}">
                                    إضافة كادر
                                </a>
                            </li>
						</ul>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li>
                                <a class="slide-item" href="{{ route('admin.employer.index') }}">
                                    قائمة أصحاب العمل
                                </a>
                            </li>
                            <li>
                                <a class="slide-item" href="{{ route('admin.employer.create') }}">
                                    إضافة صاحب عمل
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li>
                                <a class="slide-item" href="{{ route('admin.job.index', ['status' => 'Under-Review']) }}">
                                    قيد المراجعة
                                </a>
                            </li>
                            <li>
                                <a class="slide-item" href="{{ route('admin.job.index', ['status' => 'Opened']) }}">
                                    المفتوحة
                                </a>
                            </li>
                            <li>
                                <a class="slide-item" href="{{ route('admin.job.index', ['status' => 'In-Progress']) }}">
                                    قيد التنفيذ
                                </a>
                            </li>
                            <li>
                                <a class="slide-item" href="{{ route('admin.job.index', ['status' => 'Canceled']) }}">
                                    الملغاة
                                </a>
                            </li>
                            <li>
                                <a class="slide-item" href="{{ route('admin.job.create') }}">
                                    إضافة وظيفة
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="{{ route('admin.contact_us.index') }}">
