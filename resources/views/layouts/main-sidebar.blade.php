<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{ asset('Front_Assets/img/logo.png')}}" class="main-logo" alt="logo"></a>
...
{{--					</li>--}}
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li>
                                <a class="slide-item" href="{{ route('employee.index') }}">
                                    قائمة الكوادر
                                </a>
                            </li>
							<li>
                                <a class="slide-item" href="{{ route('employee.create') }}">
                                    إضافة كادر
                                </a>
                            </li>
						</ul>
