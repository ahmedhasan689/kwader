    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex ">
                ...
                <button type="button" class="btn  login-button" data-bs-toggle="modal" data-bs-target="#staticBackdropLogin">
                    دخول
                </button>
                            ...
                            <div class="modal-body">
                                <div class="social">
                                    <button class="facebook"><a href=""> <i
                                                class="fab fa-facebook-square"></i>الدخول عن طريق
                                            فيسبوك</a></button>
