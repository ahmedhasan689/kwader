                    ...
                    <div class="hhed d-flex">
                        <div class="col-lg-6 d-flex ">
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#view_info">
                                <img class="avtar" src="{{ $employee->image }}" alt="avatar">
                            </a>
                            <div class="chat-about">
                                <h6 class="m-b-0">{{ $employee->user->first_name . ' ' . $employee->user->last_name }}</h6>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu last" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li class="d-flex" style="flex-direction:column;">
                                        <p> تحرير عقد {{ $employee->user->first_name . ' ' . $employee->user->last_name }} بمسمى وظيفي
                                            <span>
                                                {{ $job->job_title }}
                                            </span>
                                        </p>
                                        ...
                                        <div class="d-flex">
                                            <a href="{{ route('contract.create', ['job' => $job->id, 'employee' => $employee->id]) }}" class="rights" style=" text-decoration: none; width: 50%;background-color: #00B398; color: #fff; height: 35px;border-radius: 5px;padding: -1px 29px; display: flex;justify-content: center;border-bottom: none;">
                                                تحرير عقد
                                            </a>
