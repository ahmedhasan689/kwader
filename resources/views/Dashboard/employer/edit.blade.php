    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.employer.update', ['id' => $user->id]) }}" data-parsley-validate="" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row row-sm">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('country_id') is-invalid @enderror" name="country_id">
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ $country->id }}" @if( $country->id == $user->employer->country_id) selected @endif>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('language_id') is-invalid @enderror" name="language_id">
                                    ...
                                    @foreach($languages as $language)
                                        <option value="{{ $language->id }}" @if( $language->id == $user->employer->language_id) selected @endif>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('gender') is-invalid @enderror" name="gender">
                                    ...
                                    <option value="Male" @if( $user->employer->gender == 'Male') selected @endif>
                                        ذكر
                                    </option>
                                    <option value="Female" @if( $user->employer->gender == 'Female') selected @endif>
                                        أنثى
                                    </option>
                                </select>
                                @error('gender')
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input class="form-control fc-datepicker" name="date_of_birth" placeholder="MM/DD/YYYY" type="text" value="{{ $user->employer->date_of_birth }}">
                            </div>
                        </div>
