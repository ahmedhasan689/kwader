    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.employee.store') }}" data-parsley-validate="" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('last_name') is-invalid @enderror" name="last_name" placeholder="أدخل الأسم الأخير" type="text">
                                @error('last_name')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" name="email" placeholder="أدخل البريد الإلكتروني" type="email">
                                @error('email')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" placeholder="أدخل رقم الجوال" type="text">
                                @error('phone_number')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
